// Vendored from shadcn-vue's chart component family (the @unovis-based
// AreaChart/LineChart helpers), converted from TypeScript to the plain-JS
// <script setup> convention this repo uses for its ui/ components.
